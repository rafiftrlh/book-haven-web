                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p
                                    class="text-sm mb-0 text-capitalize font-weight-bold">Total Books</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $bookCount }}
                                    </h5>
                                </div>
                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p
                                    class="text-sm mb-0 text-capitalize font-weight-bold">Total Readings</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $countReading }}
                                    </h5>
                                </div>
                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p
                                    class="text-sm mb-0 text-capitalize font-weight-bold">Total Borrowing</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $borrowingCount }}
                                    </h5>
                                </div>
