...
@section('content')
    ...
    @elseif (request()->is('admin/fines'))
        @include('roles.admin.__data_fines')
    @elseif (request()->is('admin/fines-late'))
        @include('roles.admin.inner_page.__fine_late_page')
    @elseif (request()->is('admin/fines-broken'))
        @include('roles.admin.inner_page.__fine_broken_page')
    @elseif (request()->is('admin/fines-lost'))
        @include('roles.admin.inner_page.__fine_lost_page')
    @elseif (request()->is('admin/fines-late-and-broken'))
        @include('roles.admin.inner_page.__fine_late_and_broken_page')
