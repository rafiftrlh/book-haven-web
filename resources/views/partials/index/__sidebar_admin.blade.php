<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" style="height: 80%;">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/fines') || request()->is('admin/fines-all') ? 'active' : '' }}"
                    href="{{ route('admin.fines') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 256"
                            style="fill: {{ request()->is('admin/fines') || request()->is('admin/fines-all') ? 'rgb(255, 255, 255)' : 'rgb(0, 0, 1)' }} ;transform: ;msFilter:;">
                            <path
