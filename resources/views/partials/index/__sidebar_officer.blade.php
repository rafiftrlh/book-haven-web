<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
                ...
                <a class="nav-link {{ request()->is('officer') ? 'active' : '' }}" href="{{ route('officer.home') }}">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            style="fill: {{ request()->is('officer') ? 'rgb(255, 255, 255)' : 'rgb(0, 0, 1)' }} ;transform: ;msFilter:;"
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('officer/data_buku') ? 'active' : '' }}"
                    href="{{ route('officer.data_buku') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            style="fill: {{ request()->is('officer/data_buku') ? 'rgb(255, 255, 255)' : 'rgb(0, 0, 1)' }} ;transform: ;msFilter:;"
                            width="1em" height="1em" viewBox="0 0 24 24">
                            <path
                    ...
                    <span class="nav-link-text ms-1">Data Books</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('officer/add-category') ? 'active' : '' }}"
                    href="{{ route('officer.add_category') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            style="fill: {{ request()->is('officer/add-category') ? 'rgb(255, 255, 255)' : 'rgb(0, 0, 1)' }} ;transform: ;msFilter:;"
                            width="1em" height="1em" viewBox="0 0 24 24">
                            <path
                                d="M19 3.25H6.75a2.43 2.43 0 0 0-2.5 2.35V18a2.85 2.85 0 0 0 2.94 2.75H19a.76.76 0 0 0 .75-.75V4a.76.76 0 0 0-.75-.75m-.75 16H7.19A1.35 1.35 0 0 1 5.75 18a1.35 1.35 0 0 1 1.44-1.25h11.06Zm0-4H7.19a3 3 0 0 0-1.44.37V5.6a.94.94 0 0 1 1-.85h11.5Z" />
                            <path
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('officer/add_author') ? 'active' : '' }}"
                    href="{{ route('officer.add_author') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            style="fill: {{ request()->is('officer/add_author') ? 'rgb(255, 255, 255)' : 'rgb(0, 0, 1)' }} ;transform: ;msFilter:;"
                            width="1em" height="1em" viewBox="0 0 24 24">
                            <path
                                d="M19 3.25H6.75a2.43 2.43 0 0 0-2.5 2.35V18a2.85 2.85 0 0 0 2.94 2.75H19a.76.76 0 0 0 .75-.75V4a.76.76 0 0 0-.75-.75m-.75 16H7.19A1.35 1.35 0 0 1 5.75 18a1.35 1.35 0 0 1 1.44-1.25h11.06Zm0-4H7.19a3 3 0 0 0-1.44.37V5.6a.94.94 0 0 1 1-.85h11.5Z" />
                            <path
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('officer/confirm_peminjaman') ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            style="fill: {{ request()->is('officer/confirm_peminjaman') ? 'rgb(255, 255, 255)' : 'rgb(0, 0, 1)' }} ;transform: ;msFilter:;"
                            width="1em" height="1em" viewBox="0 0 24 24">
                            <path
                                d="M19 3.25H6.75a2.43 2.43 0 0 0-2.5 2.35V18a2.85 2.85 0 0 0 2.94 2.75H19a.76.76 0 0 0 .75-.75V4a.76.76 0 0 0-.75-.75m-.75 16H7.19A1.35 1.35 0 0 1 5.75 18a1.35 1.35 0 0 1 1.44-1.25h11.06Zm0-4H7.19a3 3 0 0 0-1.44.37V5.6a.94.94 0 0 1 1-.85h11.5Z" />
                            <path
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('officer/data_fines') ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            style="fill: {{ request()->is('officer/data_fines') ? 'rgb(255, 255, 255)' : 'rgb(0, 0, 1)' }} ;transform: ;msFilter:;"
                            width="1em" height="1em" viewBox="0 0 24 24">
                            <path
                                d="M19 3.25H6.75a2.43 2.43 0 0 0-2.5 2.35V18a2.85 2.85 0 0 0 2.94 2.75H19a.76.76 0 0 0 .75-.75V4a.76.76 0 0 0-.75-.75m-.75 16H7.19A1.35 1.35 0 0 1 5.75 18a1.35 1.35 0 0 1 1.44-1.25h11.06Zm0-4H7.19a3 3 0 0 0-1.44.37V5.6a.94.94 0 0 1 1-.85h11.5Z" />
                            <path
